...
var Demo = (function (_super) {
    ...
    function Demo(canvas) {
        _super.call(this, Photon.ConnectionProtocol.Ws, DemoAppId, DemoAppVersion);
        this.canvas = canvas;
    ...
    // overrides
    Demo.prototype.roomFactory = function (name) {
        return new DemoRoom(this, name);
    };
    Demo.prototype.actorFactory = function (name, actorNr, isLocal) {
        return new DemoPlayer(this, name, actorNr, isLocal);
    };
    Demo.prototype.myRoom = function () {
        return _super.prototype.myRoom.call(this);
    };
    Demo.prototype.myActor = function () {
        return _super.prototype.myActor.call(this);
    };
    Demo.prototype.myRoomActors = function () {
    ...
    Demo.prototype.setupUI = function () {
        ...
        cb.onchange = function () {
            return _this.updateAutoplay(_this);
        };
...
var DemoRoom = (function (_super) {
    ...
    DemoRoom.prototype.onPropertiesChange = function (changedCustomProps, byClient) {
        ...
        if (changedCustomProps.game) {
            ...
            t.textContent = "";
            var turnsLeft = 0;
            for (var i in game.nextPlayerList) {
